...
const studios =()=>{
   return (
      ...
      <section className="relative">
         <Image src="/images/p5.webp" alt="" width={1200} height={800} className="object-cover w-full h-auto"></Image>
      ...
      <section className="py-9 relative">
         <Image src="/images/p6.png" alt="" width={1200} height={800} className="h-auto object-cover w-full"></Image>
